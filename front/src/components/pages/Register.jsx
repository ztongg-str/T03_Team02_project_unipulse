...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast("success", "Account created successfully! Welcome to UniPulse.");
      navigate("/events");
    } catch (err) {
            ...
            <div className="auth-input-group">
              ...
              <div className="auth-input-wrapper">
                ...
                <button
                  ...
                  style={{ position: "absolute", right: 8, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", padding: 4, color: "#85736B", lineHeight: 0 }}
                >
                  {showPassword ? (
